...
├── rag_pipeline.py            # RAG 파이프라인 구축
├── langgraph_agent.py         # LangGraph Agent 워크플로우
├── main.py                    # 통합 실행 스크립트
...
- `data_preprocessing.py`의 `__main__` 블록
...
### 3. `create_pet_health_agent()`
- **위치**: `langgraph_agent.py`
